...
Chit uses [pipz](https://github.com/zoobz-io/pipz) for composable reliability patterns. This guide covers how to add retry logic, timeouts, rate limiting, circuit breakers, and custom middleware to your chat applications.
