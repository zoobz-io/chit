...
Chit uses [pipz](https://github.com/zoobzio/pipz) to compose reliability patterns. When you configure options like `WithRetry` or `WithTimeout`, chit builds a processing pipeline:
